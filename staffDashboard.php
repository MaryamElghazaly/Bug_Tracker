...
require_once 'Staff.php'; // Assuming you have a Staff class
...
if (isset($_GET['userID'])) {
    ...
    if (isset($_POST['updateProfile'])) {
        ...
        if ($staffUser->updateStaffProfile($staffID, $name, $email, $password)) {
            // Profile updated successfully
            echo "Profile updated successfully.";
            // Refresh the page to reflect the changes
            header("Location: StaffDashboard.php?staffID=$staffID");
            exit();
        } else {
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="MessageStaff.php">Messages</a></li>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <table class="table table-striped">
                    <tr>
                        <th>Name:</th>
                        <td><?php echo $staffProfile['FullName']; ?></td>
                    </tr>
                    <tr>
                        <th>Email:</th>
                        <td><?php echo $staffProfile['Email']; ?></td>
                    </tr>
                </table>
                    ...
                    <div class="modal-body">
                        <form method="post">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" class="form-control" value="<?php echo $staffProfile['FullName']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="email">Email:</label>
                                <input type="email" id="email" name="email" class="form-control" value="<?php echo $staffProfile['Email']; ?>">
                            </div>
                            <div class="form-group">
